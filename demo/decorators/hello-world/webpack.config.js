...
const INPUT_FILE = path.resolve(`./demo/decorators/hello-world/hello-world.ts`)
const OUTPUT_FILE = path.resolve(`./dist/demo/decorators/hello-world/hello-world.js`)
